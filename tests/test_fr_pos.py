...
<p><b>courir</b> <span class="API" title="Prononciation API">\\ku.ʁiʁ\\</span> <span class="ligne-de-forme"><i>transitif</i></span> ou <span class="ligne-de-forme"><i>intransitif</i></span> 3<sup style="font-size:83.33%;line-height:1">e</sup> groupe<span> (</span><span style="font-size: 100%; font-weight: bold; font-variant: small-caps">voir la conjugaison</span><span>)</span></p>
<ol>
<li>Couler, s’écouler.
